...
export class DodavanjeSobeComponent implements OnInit {
  ...
  public dodajSobu() {
    ...
    headers.append('Content-Type', 'application/x-www-form-urlencoded');
    headers.append("token",localStorage.getItem("token"));
    this._http.post('http://localhost:8080/IT255-DZ13/dodavanjeSobe.php',data, { headers:headers }).subscribe( data => {
 ...
 public addRoomType() {
    ...
    this._http.post('http://localhost:8080/IT255-DZ13/addroomtype.php', data, { headers: headers}).subscribe((result) => {
